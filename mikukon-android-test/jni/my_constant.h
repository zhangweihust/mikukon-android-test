...
#define LIB_SUBSTRACE_PATH "/data/local/test/libsubstrate.so"

#define LIB_GHOST_PATH "/data/local/test/libghost.so"

#define LIB_HOOK_PATH "/data/local/test/libhook.so"
